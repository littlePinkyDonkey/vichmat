...
public class TrapezoidMethod {
    ...
    public TrapezoidMethod(Function f, double a, double b, double eps){
        this.a = a;
        this.b = b;
        this.eps = eps;
        this.f = f;
    ...
    public double getAproximatedIntegral(int n){
        double h = (b-a)/n;
        double xPrevios = a;
        double xNext = 0;
        double S = 0;
    ...
    public double getIntegral() throws IntegrableException {
        ...
        if(counter == LIMIT)throw new IntegrableException();
